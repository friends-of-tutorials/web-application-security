...
Chrome: <img alt="Sichere Verbindung" src="/images/secure.png" width="244">

Unsichere Quellen erkennt man wie folgt:

Chrome: <img alt="Sichere Verbindung" src="/images/not-secure.png" width="150">

Sichere Aufrufe, jedoch unsicher eingebundene Quellen erkennt man wie folgt:

Chrome: <img alt="Sichere Verbindung" src="/images/secure-mixed-not-secure.png" width="107">
